(() => {
  ...
  function setEnabled(value) {
    ...
    panel.querySelector(".plus-status").textContent = enabled ? "Plus is active on this browser. Your profiles stay local to this browser." : "Activate LedgerHarbor Plus to unlock these controls.";
  }
