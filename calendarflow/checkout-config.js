...
// for example: https://buy.yourdomain.com/?product=calendarflow&plan=standard
const CHECKOUT_PORTAL = "../checkout-portal/index.html";
window.PRODUCT_CHECKOUTS = Object.freeze({
  standard: `${CHECKOUT_PORTAL}?product=calendarflow&plan=standard`,
  plus: `${CHECKOUT_PORTAL}?product=calendarflow&plan=plus`,
