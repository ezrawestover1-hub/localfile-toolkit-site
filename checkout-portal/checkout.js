(() => {
  ...
  const PRODUCTS = Object.freeze({
    ledgerlift:{name:"LedgerHarbor",icon:window.PRODUCT_ICONS.ledgerlift.icon,description:"A private CSV-to-IIF converter for recurring transaction workflows. This purchase unlocks LedgerHarbor only; other products remain at their own access level.",home:"../ledgerlift/index.html",standardHome:"../ledgerlift/index.html?mode=standard",plusHome:"../ledgerlift/index.html?mode=plus",benefits:{standard:["Unlimited LedgerHarbor conversions","Preview and basic validation","Signed amount column mapping","LedgerHarbor Standard only; other products remain separate"],plus:["Everything in Standard","Saved mapping and account profiles","Advanced debit / credit mapping, categorization, duplicate review, and reports"]}},
    pixelport:{name:"PixelRefinery",icon:window.PRODUCT_ICONS.pixelport.icon,description:"Private image conversion for PNG, JPG, WebP and supported AVIF files. This purchase unlocks PixelRefinery only; other products remain at their own access level.",home:"../pixelport/index.html",standardHome:"../pixelport/index.html?mode=standard",plusHome:"../pixelport/index.html?mode=plus",benefits:{standard:["Unlimited PixelRefinery single-image conversions","Quality and output controls","PixelRefinery Standard only; other products remain separate"],plus:["Everything in Standard","Batch image queue and reusable presets (PixelRefinery Plus)","PixelRefinery Plus background, filename, and web optimization controls"]}},
    ...
    suite:{name:"Complete Plus Bundle",icons:Object.values(window.PRODUCT_ICONS).map(item=>item.icon),description:"One-time Plus entitlement for all five private converter products.",home:"../index.html",benefits:{bundle:["LedgerHarbor Plus with saved profiles, advanced mapping, categorization, duplicate review, and reports","PixelRefinery Plus","ContactCraft Plus","CalendarFlow Plus","CaptionShift Plus","Save $26.96 versus five separate Plus licenses"]}}
  });
  ...
  Object.values(PRODUCTS).forEach(item=>{if(item.benefits.plus && !["LedgerHarbor","PixelRefinery","ContactCraft","CalendarFlow","CaptionShift"].includes(item.name))item.benefits.plus=["Everything in Standard","Implemented Plus controls","Included with the applicable Plus license"];});
