(() => {
  ...
  const PRODUCTS = Object.freeze({
    ledgerlift:{name:"LedgerLift",icon:window.PRODUCT_ICONS.ledgerlift.icon,description:"Private CSV-to-IIF conversion for recurring QuickBooks Desktop workflows.",home:"../ledgerlift/index.html",standardHome:"../ledgerlift/index.html?mode=standard",plusHome:"../ledgerlift/index.html?mode=plus",benefits:{standard:["Unlimited core conversions","Preview and basic validation","No ads inside the converter"],plus:["Everything in Standard","Saved mapping and account profiles","Advanced debit / credit mapping, categorization, duplicate review, and reports"]}},
